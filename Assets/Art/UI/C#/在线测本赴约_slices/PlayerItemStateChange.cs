...
public class PlayerItemStateChange : MonoBehaviour
{
    ...
    private void Awake()
    {
        scriptTestManager = GameObject.Find("Canvas").transform.Find("ScriptTestUI").GetComponent<ScriptTestUIManager>();
